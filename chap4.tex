...
\label{BsSplotTable}
  \begin{tabular}{| c | c |c |c | c|}
    \hline
     Centrality & $B^0_s$  $p_T$ (GeV/c) & $\langle \frac{1}{\alpha \times \epsilon} \rangle'$ (Weighted) & $\langle \frac{1}{\alpha \times \epsilon} \rangle$ (Unweighed Nominal)  & Percent Deviation (\% Dev ) \\
    \hline
    \hline
...
\label{BPSplotTable}
  \begin{tabular}{| c | c |c |c | c|}
    \hline
     Centrality &   $B^+$  $p_T$ (GeV/c) & $\langle \frac{1}{\alpha \times \epsilon} \rangle'$ (Weighted) & $\langle \frac{1}{\alpha \times \epsilon} \rangle$ (Unweighed Nominal)  & Percent Deviation (\% Dev ) \\
    \hline
    \hline
...
After showing that there is no explicit bias throughout the entire analysis, next step is to evaluate statistical uncertainties of the analysis. 
