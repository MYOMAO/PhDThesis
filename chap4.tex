...
\includegraphics[width= 0.32\textwidth]{Figures/Chapter4/BsEffONLY_30_90_-1.png}
\includegraphics[width= 0.32\textwidth]{Figures/Chapter4/BsEffONLY_0_90_-1.png} 
...
\begin{figure}[hbtp]
\begin{center}
\includegraphics[width=0.45\textwidth]{Figures/Chapter4/data_PbPb_1_BptNew_1050_doubly0_0_90_signal_3gaussEffInfoTreeFit.pdf}
\includegraphics[width=0.45\textwidth]{Figures/Chapter4/data_PbPb_1_BptNew_1050_doubly0_0_90_signal_fixedEffInfoTreeFit.pdf}
\includegraphics[width=0.45\textwidth]{Figures/Chapter4/data_PbPb_1_BptNew_1050_doubly0_0_90_signal_scal+EffInfoTreeFit.pdf}
\includegraphics[width=0.45\textwidth]{Figures/Chapter4/data_PbPb_1_BptNew_1050_doubly0_0_90_signal_scal-EffInfoTreeFit.pdf}
\caption{Invariant mass fit of $B^0_s$ candidates for $B^0_s$ from 20 - 50 GeV/c and centrality from 0 to 90\% in 5.02 TeV PbPb. The signal pdf from left to right is triple gaussian (with widths and relative proportions fixed from MC), double gaussian with all the parameters fixed (including the mean), increased width (\textit{a}=1.1), and decreased width (\textit{a}=0.9).}
\label{BsSigVar}
\end{center}
\end{figure}
...
\begin{figure}[hbtp]
\begin{center}
\includegraphics[width=0.32\textwidth]{Plots/Sys/SysPDF/data_PbPb_1_Bpt_950_3gauss_doubly2_ntKp.pdf}
\includegraphics[width=0.32\textwidth]{Plots/Sys/SysPDF/data_PbPb_1_Bpt_950_fixed_doubly2_ntKp.pdf}
\includegraphics[width=0.32\textwidth]{Plots/Sys/SysPDF/data_PbPb_1_Bpt_950_scal+_doubly2_ntKp.pdf}
\includegraphics[width=0.32\textwidth]{Plots/Sys/SysPDF/data_PbPb_1_Bpt_950_scal-_doubly2_ntKp.pdf}
...
Them, we simply take the largest percent variations of the variated signal raw yields compared to the nominal ones and quote them as the systematic uncertainties. Table \ref{BsSigVarTable} and Table \ref{BsSigVarTable} summarize the signal PDF systematic uncertainties 
...
\label{BsPTShape}
  \begin{tabular}{| c | c |c | c| c| c| c| }
    \hline
     Centrality & $B^0_s$ $p_T$ (GeV/c) & Triple Gaussian &  Fixed Mean & +10\% $\sigma$ & -10\% $\sigma$  \\
    \hline
    \hline
...
\label{BsPTShape}
  \begin{tabular}{| c | c |c | c| c| c| c| }
    \hline
     Centrality & $B^+$ $p_T$ (GeV/c) & Triple Gaussian &  Fixed Mean & +10\% $\sigma$ & -10\% $\sigma$  \\
    \hline
    \hline
0 - 90\% & 7 - 10 &   \textbf{0.004\% }  &  0.235\% & 0.500\% &  0.750\% \\ 
0 - 90\% & 10 - 15 & 0.144\%  & 0.137\%  & 1.83\% &   \textbf{2.34\%}  \\ 
0 - 90\% & 15 - 20 &  \textbf{0.110\% }  & 0.066\%   &  \textbf{1.02\%} &  1.00\% \\ 
0 - 90\% & 20 - 50 &  \textbf{0.629\% }   & 0.056\%  &  1.40\%  &   \textbf{1.88\%}\\ 
0 - 30\% & 10 - 50  & 0.241\%  & 0.192\%  &1.47\% &  \textbf{1.74\%} \\ 
...
To calculate the total PDF variation, we simply add the PDF variation of the signal and background into quadrature: signal extraction uncertainties = PDF variation of signal $\oplus$ background. 
