...
Now, we have clearly seen B-meson signals and extract their signal raw yields $N_S$ from their invariant distributions. We are ready to correct the acceptance and selection efficiency of the B mesons. Before we start, we donate acceptance as \textbf{$\alpha$} and selection efficiency as \textbf{$\epsilon$}. Their product, which is \textbf{$\alpha \times \epsilon$}, is call (total) efficiency.

\subsection{Analysis Challenges}

One major challenge of acceptance 
