...
\bibitem{JetFrag} B.R. Webber, ``Fragmentation and hadronization'', Int. J. Mod. Phys. A 15S1 577-606 (2000) 
\bibitem{QuarkCoal} R. C. Hwa and C. B. Yang, ``Scaling distributions of quarks, mesons and proton for all $p_T$, energy and centrality'', Phys. Rev. C 67, 064902 (2003)
...
\bibitem{NuclearShadowing} J. Jalilian-Marian and X.N. Wang, ``Shadowing of gluons in perturbative QCD: A comparison of different models'', Phys. Rev. D63, 096001 (2001)
...
\bibitem{QCDDiffConds} E. d'Enterria et al., ``CMS physics technical design report: Addendum on high density QCD with heavy ions'', J. Phys.G 34 (2007)
...
\bibitem{QGPUniverse} S. M. Sanches Jr., F. S. Navarra, and D. A. Fogaca, ``The quark gluon plasma equation of state and the expansion of the early Universe'', Nucl. Phys. A 937 (2015) 
...
\bibitem{CriticalPointEX} S. Gupta, X. Luo, B. Mohanty, H. G. Ritter, and N. Xu, ``Scale for the Phase Diagram of Quantum Chromodynamics'', Science 332 1525-1528 (2011)
...
\bibitem{SS3} B. Paczy\'nski and P. Haensel, ``Gamma-ray bursts from quark stars'', Mon. Not. Roy. Astron. Soc. 362 1, 4 - 7 (2005)
...
\bibitem{CSBQQ}  G. S. Bali, H. Neff, T. Duessel, T. Lippert, and K. Schilling, ``Observation of string breaking in QCD'', Phys. Rev. D 71, 114513 (2005)
...
\bibitem{V2Eccent} R. S. Bhalerao and J.-Y. Ollitrault, ``Eccentricity fluctuations and elliptic flow at RHIC'', Phys. Lett. B 641, 260-264 (2006)
\bibitem{4DHydro} P. F. Kolb and U. Heinz, ``Hydrodynamic description of ultrarelativistic heavy-ion collisions'', Part of Quark-gluon plasma 4, 634-714 (2003)
...
\bibitem{GM-VFNSRef} R. S. Thorne, ``A Variable-flavor number scheme for NNLO'', Phys.Rev.D 73, 054019 (2006) 
\bibitem{POWHEGRef} S. Alioli, P. Nason, C. Oleari, and E. Re, ``A general framework for implementing NLO calculations in shower Monte Carlo programs: the POWHEG BOX'', JHEP 06 043 (2010)  
\bibitem{FONLLCal} M. Cacciari, S. Frixione, N. Houdeau, M. L. Mangano, P. Nason, and G. Ridolfi, ``Theoretical predictions for charm and bottom production at the LHC'', JHEP 10 137 (2012) 
...
\bibitem{CMSBPRAA} CMS Collaboration, ``Measurement of the ${B}^{\pm}$ Meson Nuclear Modification Factor in Pb-Pb Collisions at $\sqrt{s_{NN}} =$ 5.02 TeV'', Phys. Rev. Lett. 119 15, 152301 (2017) 
...
\bibitem{EVR} J. Song, H.-H. Li, and F.-L. Shao, ``New feature of low $p_T$ charm quark hadronization in $pp$ collisions at $\sqrt{s} = $ 7 TeV'', Eur. Phys. J. C 78 4, 344 (2018) 
...
\bibitem{RRM1} M. He, R. J. Fries, and R. Rapp, ``Heavy-quark diffusion and hadronization in quark-gluon plasma'', Phys. Rev. C 86, 014903 (2012)
...
\bibitem{CaoLH1} S. Cao, G.-Y. Qin, and S. A. Bass, ``Heavy-quark dynamics and hadronization in ultrarelativistic heavy-ion collisions: Collisional versus radiative energy loss'', Phys. Rev. C 88, 044907 (2013)
\bibitem{CaoLH2} S. Cao, G.-Y. Qin, and S. A. Bass, ``Energy loss, hadronization, and hadronic interactions of heavy flavors in relativistic heavy-ion collisions'', Phys. Rev. C 92, 024907 (2015)
\bibitem{RRM2} M. He and R. Rapp, ``Hadronization and Charm-Hadron Ratios in Heavy-Ion Collisions'', Phys. Rev. Lett. 124, 042301 (2020)
...
\bibitem{ALICEDsD0Ref} ALICE Collaboration, ``Measurement of $D^0$, $D^+$, $D^{*+}$, and $D_s^+$ production in Pb - Pb collision at $\sqrt{s_{NN}} = $ 5.02 TeV'', JHEP 10 174 (2018) 
...
\bibitem{CharmThermal} H. van Hees and R. Rapp, ``Thermalization of heavy quarks in the quark-gluon plasma'',  Phys. Rev. C 71, 034907 (2005)
...
\bibitem{BAnaDimuonTrigger} Z. Shi, ``Measurement of $B^0_s$ and $B^+$ meson yields in PbPb collisions at $\sqrt{s_{NN}} = $ 5.02 TeV'', CMS-PAS-HIN-19-011
\bibitem{CMSSilicon} CMS Collaboration, ``The Phase-2 Upgrade of the CMS Tracker'', CERN-LHCC-2017-009

\bibitem{CMSTrackComp} M. Swartz, D. Fehling, G. Giurgiu, P. Maksimovic, and V. Chiochia, ``A new technique for the reconstruction, validation, and simulation of hits in the CMS pixel detector'', PoS VERTEX2007 035 (2007)

\bibitem{ClusAlgo} CMS Collaboration, ``Description and performance of track and primary-vertex reconstruction with the CMS tracker'', JINST 9 10, P10009 (2014)
...
%Chapter4
\bibitem{OmegaRef} N. P. Samios, ``Baryon spectroscopy and the omega minus'', International conference on the history of original ideas and basic discoveries in particle physics, Erice, Italy (1994) 
...
\bibitem{DAAlgo} K. Rose, ``Deterministic Annealing for Clustering, Compression, Classification, Regression, and related Optimization Problems'', Proceedings of the IEEE 86 (1998)
...
\bibitem{PbPbMulti} CMS Collaboration, ``Dependence on pseudorapidity and centrality of charged hadron production in PbPb collisions at $\sqrt{s_{NN}} = $ 2.76 TeV'', JHEP 08 141 (2011)
\bibitem{MVARef} T. W. Anderson, ``An Introduction to Multivariate Analysis'', New York, Wiley (1958) 
\bibitem{KSTest} V. W. Berger and Y. Zhou, ``Kolmogorov - Smirnov test: Overview'', Wiley Statsref: Statistics Reference Online (2014)
\bibitem{BoostingRef} M. Kearns and L. Valiant (1989). Cryptographic limitations on learning Boolean formulae and finite automata. Symposium on Theory of Computing. 21. ACM. 433 - 444. (1989)
...
\bibitem{ROOFIT} W. Verkerke and D. P. Kirkby, ``The RooFit toolkit for data modeling'', eConf. C0303241, MOLT007 (2003) 
\bibitem{AN-19-219} CMS Collaboration, ``B meson production in PbPb data: signal extraction and MC validation'', Technical Report CMS-AN-19-219, CERN, Geneva (2019)
