...
Figure \ref{BmesonDataCent} shows $B^0_s$ and $B^+$ $p_T$ integrated cross section as a function of average number of participants $\langle N_{part}\rangle$, with the correspondencing PbPb collision centrality labeled in the plot
 

\begin{figure}[hbtp]
\begin{center}
\includegraphics[width=0.70\textwidth]{Figures/Chapter5/xsec_vsCent.pdf}
\caption{The measurement of $B^0_s$ and $B^+$ cross section $\frac{1}{T_{AA}} N$ measurement as a function of $\langle N_{part}\rangle$ at different PbPb collision centralities within B-meson $p_T$ from 10 - 50 GeV/c is shown above. }
...
\caption{The measurement of $B^0_s/B^+$ as a function of $p_T$ is shown above. The open markers from 7 - 10 GeV/c stand for the fiducial measurements at B-meson rapidity of $1.5 < |y| < 2.4$.}
